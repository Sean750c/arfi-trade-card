...
interface AmountOrderBonusModalProps {
  visible: boolean;
  onClose: () => void;
...
function AmountOrderBonusModal({ visible, onClose, bonusData, currencySymbol }: AmountOrderBonusModalProps) {
